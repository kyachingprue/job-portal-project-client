    ...
    <div className='bg-white'>
      <div className='flex justify-center my-20 items-center gap-10'>
        <div className='relative'>
          <img className='rounded-xl' src={laptopTypeImg} alt="" />
          <div>
          ...
          <div className='w-14 h-14 absolute top-64 right-32 bg-blue-600 py-2 px-3 rounded-full'>
            <IoCheckmark className='text-white text-4xl' />
          </div>
        </div>
        <div className='ml-10'>
          <h3 className='text-4xl font-semibold text-black'>Millions of Jobs. Find the one that suits you.</h3>
          <p className='text-gray-600 text-sm py-5'>Search all the open positions on the web. Get your own personalized salary estimate. Read reviews on over 600,000 companies worldwide.</p>
      ...
      <div className='flex justify-around text-center items-center py-16'>
        <div className='text-center'>
          <h4 className='text-5xl font-bold'>4M</h4>
          <p className='text-sm text-gray-600 py-4'>4 million daily active users</p>
        </div>
        <div className='text-center'>
          <h4 className='text-5xl font-bold'>12K</h4>
          <p className='text-sm text-gray-600 py-4'>Over 12k open job positions</p>
        </div>
        <div className='text-center'>
          <h4 className='text-5xl font-bold'>20M</h4>
          <p className='text-sm text-gray-600 py-4'>Over 20 million stories shared</p>
        </div>
      </div>
    </div>
  );
